...
$sql = "SELECT * FROM goingevent where orgEmail = '$ORGEmail' and flagNotification='true'";
$result = $conn->query($sql);
$Sql_Query = "UPDATE goingevent SET flagNotification='false' WHERE  orgEmail='$ORGEmail'";
